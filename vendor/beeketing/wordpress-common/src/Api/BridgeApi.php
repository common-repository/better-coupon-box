...
namespace BeeketingBCBCommon\Api;
...
use BeeketingBCBCommon\Data\Api;
use BeeketingBCBCommon\Data\Constant;
use BeeketingBCBCommon\Data\Setting;
use BeeketingBCBCommon\Manager\CartManager;
use BeeketingBCBCommon\Manager\CollectionManager;
use BeeketingBCBCommon\Manager\CollectManager;
use BeeketingBCBCommon\Libraries\Helper;
use BeeketingBCBCommon\Libraries\SettingHelper;
use BeeketingBCBCommon\Manager\CustomerManager;
use BeeketingBCBCommon\Manager\OrderManager;
use BeeketingBCBCommon\Manager\ProductManager;
use BeeketingBCBCommon\Manager\VariantManager;
...
class BridgeApi
{
     ...
     * @resource setting
     */
    protected function put_setting_beeketing( Request $request )
    {
        $this->put_setting( $request );
    }
